 ...
 */
public class issueBookCE extends javax.swing.JFrame {

    /**
     * Creates new form issueBookCE
     */
    public issueBookCE() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Issue Book (For CE)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            ResultSet rs=st.executeQuery("select *from bookCE where BookID='"+BookID+"'");
            if(rs.next())
            {
                ResultSet rs1=st.executeQuery("select *from student where StudentID='"+StudentID+"'");
                if(rs1.next())
                {
                    st.executeUpdate("insert into issueCE values('"+BookID+"','"+StudentID+"','"+issueDate+"','"+dueDate+"','"+returnBook+"')");
                    JOptionPane.showConfirmDialog(null, "Book successfully issued");
                    setVisible(false);
                    new issueBookCE().setVisible(true);
                }
                else
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(issueBookCE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
