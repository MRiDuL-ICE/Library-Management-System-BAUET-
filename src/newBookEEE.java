 ...
 */
public class newBookEEE extends javax.swing.JFrame {

    /**
     * Creates new form newBookEEE
     */
    public newBookEEE() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            st.executeUpdate("insert into bookEEE values('"+BookID+"','"+name+"','"+writter+"','"+publisher+"','"+price+"','"+edition+"','"+page+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(newBookEEE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
