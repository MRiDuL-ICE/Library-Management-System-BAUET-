 ...
 */
public class newBookME extends javax.swing.JFrame {

    /**
     * Creates new form newBookME
     */
    public newBookME() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            st.executeUpdate("insert into bookME values('"+BookID+"','"+name+"','"+writter+"','"+publisher+"','"+price+"','"+edition+"','"+page+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(newBookME.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
