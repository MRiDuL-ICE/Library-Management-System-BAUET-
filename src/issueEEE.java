 ...
 */
public class issueEEE extends javax.swing.JFrame {

    /**
     * Creates new form issueEEE
     */
    public issueEEE() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Issue Book (For EEE)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            ResultSet rs=st.executeQuery("select *from bookEEE where BookID='"+BookID+"'");
            if(rs.next())
            {
                ResultSet rs1=st.executeQuery("select *from student where StudentID='"+StudentID+"'");
                if(rs1.next())
                {
                    st.executeUpdate("insert into issueEEE values('"+BookID+"','"+StudentID+"','"+issueDate+"','"+dueDate+"','"+returnBook+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(issueEEE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
