 ...
 */
public class newBookCSE extends javax.swing.JFrame {

    /**
     * Creates new form newBookCSE
     */
    public newBookCSE() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            st.executeUpdate("insert into bookCSE values('"+BookID+"','"+name+"','"+writter+"','"+publisher+"','"+price+"','"+edition+"','"+page+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(newBookCSE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
